        ...
        <div class="row">
            ...
            <div class="col-md-5 col-md-push-2">
                <div id="product-main-img">
                    ...
                    <div class="product-preview">
                        <img src="{{ asset('storage/image/produk/'.$produk->gambar2) }}" width="20%" alt="Gambar 1">
                    </div>
            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <h5 style="color: darkgoldenrod">Stok {{$produk->stok}} Pcs</h5>
                    <div>
                        <h3 class="product-price">Rp.{{$produk->harga}}</h3>
